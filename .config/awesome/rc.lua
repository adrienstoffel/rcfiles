...
-- {{{ Tags
tags = {
	names = {" α ", " β ", " γ ", " δ ", " ε ", " λ ", " Σ ", "IRC", "Web", "Music", "RSS", " Ω "},
	layout = {
		layouts[2],  -- screen "α" : tile
		layouts[2],  -- screen "β" : tile
		layouts[2],  -- screen "γ" : tile
		layouts[2],  -- screen "δ" : tile
		layouts[2],  -- screen "ε" : tile
		layouts[1],  -- screen "λ" : float
		layouts[1],  -- screen "Σ" : float
		layouts[10], -- screen "IRC" : max
		layouts[1],  -- screen "Web" : float
		layouts[1],  -- screen "Mail" : tile
		layouts[1],  -- screen "VM" : float
		layouts[1]   -- screen "Ω" : float
	}
}
...
my_fs_home=blingbling.progress_graph.new()
my_fs_home:set_height(18)
my_fs_home:set_width(40)
my_fs_home:set_show_text(true)
my_fs_home:set_horizontal(true)
my_fs_home:set_rounded_size(0.2)
vicious.register(my_fs_home, vicious.widgets.fs, "${/home used_p}", 120)

my_fs_home_legend = wibox.widget.textbox()
my_fs_home_legend:set_text(" /home: ")
...
for s = 1, screen.count() do
	...
	right_layout:add(my_fs_home_legend)
	right_layout:add(my_fs_home)
...
globalkeys = awful.util.table.join(
	awful.key({ modkey, "Shift"   }, "<", function () awful.util.spawn("slock") end),
    -- Take a screenshot
    -- https://github.com/copycat-killer/dots/blob/master/bin/screenshot
    --awful.key({ altkey }, "p", function() os.execute("screenshot") end),
	awful.key({                   }, "Print", function () awful.util.spawn("xfce4-screenshooter -s ~/screenshots") end),
	awful.key({ modkey            }, "F12", function () awful.util.spawn("dolphin") end),
